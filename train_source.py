...
def cal_acc(loader, netF, netH, netB, netC, flag=False):
    ...
    with torch.no_grad():
        ...
        for i in range(len(loader)):
            ...
            fusion_model = network.AdaptiveFeatureFusion(dim_F=1024, dim_H=345).cuda()  # swin_l 1536 swin_b 1024
...
if __name__ == "__main__":
    ...
    parser.add_argument('--net', type=str, default='swin_b', help="vgg16, resnet50, resnet101, swin_l")
